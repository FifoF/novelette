...
\mode{draft}
\intent{none}
\setfont{main}{default}
\setfont{deco}{default}
\setlang{en-US}
\warnalert
\setmicrotype{default}
\labelfont
\begin{document}
\frontmatter
...
\begin{display}
\vfil
{\centering\ital{Give 'em Hell}\par}
\vfil
\end{display}
...
\null\null\null\null\null\null\null\null
\end{opening}
\init{S}{amuel Clemens,} known as Mark Twain, opined that the Art of Lying
was in decay. This is an excerpt from his speech.

\scene{-}

I do not mean to suggest that the \ital{custom} of lying has
...
the memo braces will print.
  You may use multiple lines. If you write any TeX code within the memo
it will be ignored (unless it is a syntax error).
  Unlike the percent comment, a memo is not placed at the end of a line.
It must be separate from any paragraph (or other content) above and below.}
